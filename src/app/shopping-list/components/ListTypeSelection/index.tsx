...
import { ShoppingListType } from "@/app/type";

interface ListTypeSelectionProps {
  onSelectListType: (type: ShoppingListType) => void;
}

export default function ListTypeSelection({
  onSelectListType,
}: ListTypeSelectionProps) {
  return (
    <div className="bg-gray-50 px-4 py-10">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div
            onClick={() => onSelectListType("standalone")}
          ...
          {/* Inventory-Based List Option */}
          <div
            onClick={() => onSelectListType("inventory-based")}
